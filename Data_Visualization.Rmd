...
The original data set is too large to push to Github. I cleaned the data in another data_wrangling file. The cleaned data only contains records from 2020/01/20 to 2022/12 and 7 variables.
